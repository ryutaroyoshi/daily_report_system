...
public interface JpaConst {
    ...
    String EMP_CLO_NAME = "name"; //氏名
    String EMP_CLO_PASS = "password"; //パスワード
    String EMP_CLO_ADMIN_FLAG = "admin_flag"; //管理者権限
    ...
    String REP_CLO_UPDATED_AT = "updated_at";
    ...
    String Q_REP_ALL_MINE = ENTITY_REP + ".getAllMine";
    String Q_REP_ALL_MINE_DEF = "SELECT r FROM Report AS r WHERE r.employee = :" + JPQL_PARM_EMPLOYEE + "ORDER BY e.id DESC";
